...
gfx/diploma/diploma.2bpp.lz: LZFLAGS += --iterate-only
...
gfx/pokedex/pokedex.2bpp.lz: LZFLAGS += --iterate-only
...
gfx/title/logo_gold.2bpp.lz: LZFLAGS += --iterate-only --align 1
gfx/title/logo_silver.2bpp.lz: LZFLAGS += --iterate-only --align 1
