...
EXPORT DEF wBattleAnimAddress EQU $CA10
EXPORT DEF wBattleAnimByte EQU $CA17
...
EXPORT DEF wTempObjectCopySprite EQU $CE6F
EXPORT DEF wTempObjectCopySpriteVTile EQU $CE70
EXPORT DEF wTempObjectCopyPalette EQU $CE71
EXPORT DEF wTempObjectCopyMovement EQU $CE72
EXPORT DEF wTempObjectCopyRange EQU $CE73
EXPORT DEF wTempObjectCopyX EQU $CE74
EXPORT DEF wTempObjectCopyY EQU $CE75
EXPORT DEF wTempObjectCopyRadius EQU $CE76
EXPORT DEF wTileDown EQU $CE78
EXPORT DEF wTileUp EQU $CE79
EXPORT DEF wTileLeft EQU $CE7A
EXPORT DEF wTileRight EQU $CE7B
EXPORT DEF wTilePermissions EQU $CE7C
EXPORT DEF wWindowStackPointer EQU $CE7D
EXPORT DEF wMenuJoypad EQU $CE7F
EXPORT DEF wMenuSelection EQU $CE80
EXPORT DEF wWhichIndexSet EQU $CE82
EXPORT DEF wMenuHeader EQU $CE8D
EXPORT DEF wMenuFlags EQU $CE8D
EXPORT DEF wMenuBorderTopCoord EQU $CE8E
EXPORT DEF wMenuBorderLeftCoord EQU $CE8F
EXPORT DEF wMenuBorderBottomCoord EQU $CE90
EXPORT DEF wMenuBorderRightCoord EQU $CE91
EXPORT DEF wMenuDataPointer EQU $CE92
EXPORT DEF wMenuCursorPosition EQU $CE94
EXPORT DEF wMenuHeaderEnd EQU $CE9D
EXPORT DEF wMenuData EQU $CE9D
EXPORT DEF wMenuDataFlags EQU $CE9D
EXPORT DEF wMenuDataItems EQU $CE9E
EXPORT DEF wMenuDataIndicesPointer EQU $CE9F
EXPORT DEF wMenuData_2DMenuItemStringsBank EQU $CEA0
EXPORT DEF wMenuDataDisplayFunctionPointer EQU $CEA1
...
EXPORT DEF wWhichHPBar EQU $D0C2
...
EXPORT DEF wNextMapNumber EQU $D100
EXPORT DEF wPrevWarp EQU $D101
EXPORT DEF wPrevMapGroup EQU $D102
EXPORT DEF wPrevMapNumber EQU $D103
EXPORT DEF wBGMapAnchor EQU $D118
EXPORT DEF wUsedSprites EQU $D11A
EXPORT DEF wd120 EQU $D120
EXPORT DEF wOverworldMapAnchor EQU $D13A
EXPORT DEF wPlayerMetatileY EQU $D13C
EXPORT DEF wPlayerMetatileX EQU $D13D
EXPORT DEF wMapPartial EQU $D13E
...
EXPORT DEF wTempEnemyMonSpecies EQU $D1AA
EXPORT DEF wTempBattleMonSpecies EQU $D1AB
EXPORT DEF wBattleMode EQU $D1D3
EXPORT DEF wBattleType EQU $D1D6
EXPORT DEF wTrainerClass EQU $D1DA
EXPORT DEF wCurBaseData EQU $D1DD
EXPORT DEF wBaseDexNo EQU $D1DD
EXPORT DEF wBasePicSize EQU $D1EE
...
EXPORT DEF wTimeOfDay EQU $D214
EXPORT DEF wMapStatus EQU $D216
EXPORT DEF wScriptFlags EQU $D218
EXPORT DEF wScriptMode EQU $D21B
...
EXPORT DEF wCurMapWarpEventsPointer EQU $DA49
EXPORT DEF wCurMapCoordEventCount EQU $DA4B
EXPORT DEF wCurMapCoordEventsPointer EQU $DA4C
EXPORT DEF wCurMapBGEventCount EQU $DA4E
EXPORT DEF wCurMapBGEventsPointer EQU $DA4F
EXPORT DEF wCurMapObjectEventCount EQU $DA51
EXPORT DEF wCurMapObjectEventsPointer EQU $DA52
EXPORT DEF wCurMapSceneScriptCount EQU $DA54
...
EXPORT DEF wBackupWarpNumber EQU $DAF4
EXPORT DEF wBackupMapGroup EQU $DAF5
EXPORT DEF wBackupMapNumber EQU $DAF6
EXPORT DEF wLastSpawnMapGroup EQU $DAFA
EXPORT DEF wLastSpawnMapNumber EQU $DAFB
EXPORT DEF wWarpNumber EQU $DAFC
EXPORT DEF wMapGroup EQU $DAFD
EXPORT DEF wMapNumber EQU $DAFE
...
SECTION "wram2", WRAMX[$D143], BANK[1]
wMapAttributes::
wMapBorderBlock:: db
...
SECTION "wram6", WRAMX[$D1AC], BANK[1]
